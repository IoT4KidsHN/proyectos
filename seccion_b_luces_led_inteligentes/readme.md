...
El proyecto Luces LED Inteligentes de IoT4Kids permite a los estudiantes explorar cómo la tecnología puede transformar objetos cotidianos en sistemas inteligentes y automatizados. Utilizando LEDs RGB, sensores ambientales (como luz, temperatura o movimiento) y una placa microcontroladora (como Arduino o Raspberry Pi), los participantes crean un sistema de iluminación capaz de responder dinámicamente a su entorno.
